...
* QQPlot is the quantiles plots for evaluating the fitting, and the quantiles are generated by Newton method. In QQPlot function, it will provide the comparison about QQplot between two different claims distributions by **QQPlot(claims_data.number)**. 
